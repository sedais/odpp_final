...
text = "My name is Clara and I live in Vienna California Ist das eine Frage Frau Müller"

# Define a "Named Entity Recognition" pipeline: is a subtask of information extraction that seeks to locate and
